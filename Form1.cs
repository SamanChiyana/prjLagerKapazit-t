...
namespace LagerKapazität
{
    public partial class Form1 : Form
    {
        ...
        private string richtigerUsername = "UserName";
        private string richtigesPasswort = "Passwort"; // Aktuelles Passwort
        ...
        private string emailAdresse = "deineEmailAdresse"; // Deine E-Mail-Adresse
        ...
        private void SendeNeuesPasswort()
        {
            ...
            try
            {
                ...
                client.Credentials = new NetworkCredential("deineEmailAdresse", "2-Faktor-Authentifizierung AppPasswort "); // App-Passwort
